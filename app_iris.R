...
# Asigno numeración random por grupos para poder así la app revisar cuando esten mal mapeados y no duplicar IDs ----
...
server <- function(input, output, session) {
 ...
 # Defino abreviacion del cientifico
  cientificos <- reactive({iniciales_a[input$nombre]})
  
  # Defino abreviacion de la especie
...
#Paso UI y Server generados a la app
shinyApp(ui, server)
